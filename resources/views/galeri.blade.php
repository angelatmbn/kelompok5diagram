    ...
    <div class="container-fluid">
      ...
      <div class="col-md-12">
        ...
        <div class="product-item bg-white p-3 rounded shadow-sm">
          ...
          <img src="{{ Storage::url($p->foto) }}" class="tab-image img-fluid rounded"
          ...
          <span class="input-group-btn">
            <button type="button" class="quantity-left-minus btn btn-danger btn-number rounded-start"
          ...
          <span class="input-group-btn">
            <button type="button" class="quantity-right-plus btn btn-success btn-number rounded-end"
