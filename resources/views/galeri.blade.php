                  ...
                  <div class="col mb-4">
                    <div class="product-item bg-white p-3 rounded shadow-sm">
                      ...
                      <figure class="text-center mb-4">
                        <a href="{{ Storage::url($p->foto) }}" title="{{$p->nama_menu}}">
                          <img src="{{ Storage::url($p->foto) }}" class="tab-image img-fluid rounded" style="max-height: 200px; object-fit: cover;">
                        </a>
                      </figure>
                      <div class="product-details">
                        <h3 class="product-title fs-5 mb-2">{{$p->nama_menu}}</h3>
                        <div class="product-meta d-flex justify-content-between align-items-center mb-2">
                          ...
                          <span class="rating d-flex align-items-center">
                            <svg width="16" height="16" class="text-warning me-1">
                        ...
                        <div class="price-wrap mb-3">
                          <span class="price fs-5 fw-bold text-primary">{{rupiah($p->harga*1.2)}}</span>
                        </div>
                        <div class="d-flex align-items-center justify-content-between">
                          <div class="input-group product-qty" style="max-width: 120px">
                            <span class="input-group-btn">
                              <button type="button" class="quantity-left-minus btn btn-danger btn-number rounded-start" data-id="{{ $p->id }}" data-type="minus">
                                <svg width="16" height="16">
                                  <use xlink:href="#minus"></use>
                                </svg>
                              </button>
                            </span>
                            <input type="text" id="quantity-{{ $p->id }}" name="quantity" class="form-control input-number text-center" value="1">
                            <span class="input-group-btn">
                              <button type="button" class="quantity-right-plus btn btn-success btn-number rounded-end" data-id="{{ $p->id }}" data-type="plus">
                                <svg width="16" height="16">
